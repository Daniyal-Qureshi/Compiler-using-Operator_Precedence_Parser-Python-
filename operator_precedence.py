...
def GUI():
	...
	win.title("Operator Precedence Parser")
	win.geometry("1300x650")
	# win.resizable(False,False)
	label=tk.Label(win,text="Operator Precedence Parser")
	label.config(font=("Arial",20),background="gray")
	label.pack()
	lab=tk.Label(win,text="Designed by Daniyal Qureshi",font=("Arial",15),background="gray").place(x=500,y=600)
